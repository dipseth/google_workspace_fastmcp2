                ...
                "sections": [
                    {
                        ...
                        "widgets": [
                            {
                                "textParagraph": {
                                    "text": "All systems operational. Last incident: 3 days ago."
                                }
                            },
                            {
                                "decoratedText": {
                ...
                "sections": [
                    {
                        "widgets": [
                            {
                                "textParagraph": {
                                    "text": "Pipeline #1847 — Branch: main — Commit: a3f2b1c"
                                }
                            },
                        ]
                    },
                                    ...
                                    "carouselCards": [
                                        {
                                            "widgets": [
                                                {
                                                    "textParagraph": {
                                                        "text": "<b>Step 1: Build</b>\nCompile & package"
                                                    }
                                                },
                                                {
                                                    "textParagraph": {
                                                        "text": "Docker image built in 2m 14s"
                                                    }
                                                },
                                            ],
                                            "footerWidgets": [
                                        ...
                                        },
                                        {
                                            "widgets": [
                                                {
                                                    "textParagraph": {
                                                        "text": "<b>Step 2: Test</b>\nUnit + Integration"
                                                    }
                                                },
                                                {
                                                    "textParagraph": {
                                                        "text": "342 tests passed, 0 failed"
                                                    }
                                                },
                                            ],
                                            "footerWidgets": [
                                        ...
                                        },
                                        {
                                            "widgets": [
                                                {
                                                    "textParagraph": {
                                                        "text": "<b>Step 3: Deploy</b>\nRolling update"
                                                    }
                                                },
                                                {
                                                    "textParagraph": {
                                                        "text": "Deployed to 3/3 pods successfully"
                                                    }
                                                },
                                            ],
                                            "footerWidgets": [
...
def main():
    ...
    print(
        f"Ground-truth: {total_pairs} content→pool pairs across {len(ground_truth)} cards"
    )
    print()
