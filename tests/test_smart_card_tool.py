        ...
        try:
            ...
            class MockClient:
                async def call_tool(self, *args, **kwargs):
                    return [type('obj', (object,), {'text': '{"header": {"title": "Test Card"}, "sections": [{"widgets": [{"textParagraph": {"text": "This is a test card"}}]}]}'})]
                
                async def list_tools(self):
                    return [type('obj', (object,), {'name': 'send_smart_card'}),
                            type('obj', (object,), {'name': 'create_card_from_template'}),
                            type('obj', (object,), {'name': 'preview_card_from_description'}),
                            type('obj', (object,), {'name': 'optimize_card_layout'}),
                            type('obj', (object,), {'name': 'create_multi_modal_card'})]
