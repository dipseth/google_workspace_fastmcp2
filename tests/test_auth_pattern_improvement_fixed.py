...
class TestImprovedAuthPattern:
    ...
    async def test_list_gmail_labels_tool_available(self, client):
        ...
        try:
            ...
            print(f"   📧 Full Response from list_gmail_labels:")
            print(f"   {content}")
            ...
            try:
                ...
                print(f"   ⚠️ Response is not JSON, raw text response shown above")
            
            print(f"✅ Tool execution test completed")
    ...
    async def test_list_gmail_labels_with_explicit_email(self, client):
        ...
        print(f"✅ Explicit email parameter test passed")
    ...
    async def test_list_gmail_labels_without_email_parameter(self, client):
        ...
        try:
            ...
            print(f"✅ Middleware auto-injection test passed")
            ...
            if "required" in error_message or "missing" in error_message:
                print(f"🔄 Tool requires parameter at client level - middleware injection happens server-side")
    ...
    async def test_middleware_authentication_flow_priority(self, client):
        ...
        print(f"✅ Authentication flow priority test completed")
    ...
    async def test_jwt_middleware_integration(self, client):
        ...
        if auth_config:
            ...
            print(f"✅ JWT middleware integration test completed")
        else:
...
class TestMiddlewareEnhancements:
    ...
    async def test_auth_priority_documentation(self, client):
        ...
        print(f"✅ Authentication priority flow verified")
    ...
    async def test_enhanced_error_messages(self, client):
        ...
        print(f"✅ Enhanced error messages verified")
