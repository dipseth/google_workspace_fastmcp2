...
class TestDriveScopesProperty:
    ...
    def test_drive_scopes_contains_drive_scopes(self):
        ...
        found_drive_scopes = [scope for scope in scopes if any(pattern in scope for pattern in drive_scope_patterns)]
...
class TestScopeRegistry:
    ...
    def test_scope_registry_has_required_services(self):
        ...
        for service in required_services:
            assert service in ScopeRegistry.GOOGLE_API_SCOPES, f"Missing service: {service}"
