...
async def test_service_resources():
    ...
    logger.info("2. When a service:// URI is accessed, TagBasedResourceMiddleware intercepts it")
    logger.info("3. Middleware parses the URI pattern and identifies the service/list_type/item_id")
