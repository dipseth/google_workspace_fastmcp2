...
class TestServiceListItemsWithMockAuth:
    ...
    @pytest.mark.asyncio
    async def test_forms_list_structure(self, client):
    ...
    @pytest.mark.asyncio
    async def test_photos_albums_structure(self, client):
    ...
    @pytest.mark.asyncio
    async def test_calendar_events_with_id_structure(self, client):
    ...
    @pytest.mark.asyncio
    async def test_detail_view_structure(self, client):
