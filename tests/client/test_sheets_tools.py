...
class TestSheetsTools:
    ...
    async def test_list_spreadsheets(self, client):
        ...
        result = await client.call_tool(
            "list_spreadsheets", {"user_google_email": TEST_EMAIL, "max_results": 10}
        )
    ...
    async def test_create_spreadsheet(self, client):
        ...
        pytest.skip(
            "Use a stable spreadsheet via TEST_GOOGLE_SHEET_ID; spreadsheet creation is environment-dependent"
        )
    ...
    async def test_get_spreadsheet_info(self, client, test_spreadsheet_id):
        ...
        result = await client.call_tool(
            "get_spreadsheet_info",
            {"user_google_email": TEST_EMAIL, "spreadsheet_id": test_spreadsheet_id},
        )
    ...
    @pytest.mark.asyncio
    async def test_format_sheet_range_cell_formatting(
        self, client, test_spreadsheet_id, test_sheet_id
    ):
    ...
    @pytest.mark.asyncio
    async def test_format_sheet_range_no_formatting_options(
        self, client, test_spreadsheet_id, test_sheet_id
    ):
...
class TestSheetsIntegration:
    ...
    async def test_sheets_error_handling(self, client):
        ...
        result = await client.call_tool(
            "get_spreadsheet_info",
            {"user_google_email": TEST_EMAIL, "spreadsheet_id": "invalid_id_12345"},
        )
