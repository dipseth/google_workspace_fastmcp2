...
from .base_test_config import TEST_EMAIL as DEFAULT_TEST_EMAIL, create_test_client
...
async def test_gmail_reply_with_real_messages():
    ...
    try:
        ...
        async with client:
            ...
            send_result = await runner.test_tool_with_explicit_email("send_gmail_message", {
                "to": [RECIPIENT_EMAIL],
                "cc": [CC_EMAIL] if CC_EMAIL and CC_EMAIL != RECIPIENT_EMAIL else [],
            ...
            if send_result and send_result.get("success"):
                ...
                try:
                    ...
                    if send_data.get("success") and send_data.get("messageId"):
                        ...
                        print(f"✅ Email sent successfully! Message ID: {sent_message_id}")
            ...
            if not sent_message_id:
                ...
                if search_result and search_result.get("success"):
                    ...
                    try:
                        ...
                        if search_data.get("messages") and len(search_data["messages"]) > 0:
                            sent_message_id = search_data["messages"][0]["id"]
                            print(f"✅ Found message via search! Message ID: {sent_message_id}")
                    except json.JSONDecodeError:
                        pass
            ...
            reply_result = await runner.test_tool_with_explicit_email("reply_to_gmail_message", {
            ...
            if reply_result and reply_result.get("success"):
                ...
                try:
                    ...
                    if reply_data.get("success"):
                        ...
                        print(f"   • Reply message ID: {reply_data.get('reply_message_id')}")
            ...
            if CC_EMAIL and CC_EMAIL != RECIPIENT_EMAIL:
                ...
                reply_all_result = await runner.test_tool_with_explicit_email("reply_to_gmail_message", {
                    "message_id": sent_message_id,
            ...
            custom_reply_result = await runner.test_tool_with_explicit_email("reply_to_gmail_message", {
                "message_id": sent_message_id,
            ...
            if custom_reply_result and custom_reply_result.get("success"):
                ...
                try:
                    reply_data = json.loads(result_text)
                    if reply_data.get("success"):
                        print(f"✅ Custom reply sent successfully!")
                        print(f"   • Reply mode: {reply_data.get('reply_mode')}")
                        print(f"   • To recipients: {reply_data.get('to_recipients')}")
                        print(f"   • CC recipients: {reply_data.get('cc_recipients')}")
                except json.JSONDecodeError:
            ...
            draft_reply_result = await runner.test_tool_with_explicit_email("draft_gmail_reply", {
                "message_id": sent_message_id,
            ...
            if draft_reply_result and draft_reply_result.get("success"):
                ...
                try:
                    ...
                    if draft_data.get("success"):
                        print(f"✅ Draft reply created successfully!")
            ...
            html_reply_result = await runner.test_tool_with_explicit_email("reply_to_gmail_message", {
                "message_id": sent_message_id,
            ...
            if html_reply_result and html_reply_result.get("success"):
                ...
                try:
                    reply_data = json.loads(result_text)
                    if reply_data.get("success"):
                        print(f"✅ HTML reply sent successfully!")
            ...
            mixed_reply_result = await runner.test_tool_with_explicit_email("reply_to_gmail_message", {
                "message_id": sent_message_id,
            ...
            if mixed_reply_result and mixed_reply_result.get("success"):
                ...
                try:
                    reply_data = json.loads(result_text)
                    if reply_data.get("success"):
                        print(f"✅ Mixed content reply sent successfully!")
                        print(f"   • Content type: {reply_data.get('content_type')}")
                except json.JSONDecodeError:
                    pass
...
def run_test():
    ...
    print("   All addresses are on the allow list, so no elicitation will be triggered.")
    print()
