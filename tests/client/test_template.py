...
class TestTemplateService:
    ...
    async def test_primary_tool_auth_patterns(self, client):
        ...
        explicit_valid = (
            auth_results["explicit_email"]["success"]
            or auth_results["explicit_email"]["is_auth_related"]
        )

        middleware_valid = (
            auth_results["middleware_injection"]["success"]
            or auth_results["middleware_injection"]["param_required_at_client"]
        )
