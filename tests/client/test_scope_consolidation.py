...
class TestScopeConsolidation:
    ...
    def test_scope_registry_initialization(self, scope_registry):
        ...
        for service in expected_services:
            ...
            assert (
                len(service_scopes) > 0
            ), f"Service {service} should have scopes defined"
    ...
    def test_compatibility_shim_scope_groups(self, compatibility_shim):
        ...
        assert (
            scope_groups["drive_read"]
            == "https://www.googleapis.com/auth/drive.readonly"
        )
        assert (
            scope_groups["gmail_send"] == "https://www.googleapis.com/auth/gmail.send"
        )
    ...
    def test_integration_service_manager(self):
        ...
        try:
            ...
            assert (
                "drive.readonly" in drive_read
            ), "drive_read should resolve to readonly scope"
    ...
    def test_integration_service_helpers(self):
        ...
        try:
            ...
            assert isinstance(
                gmail_defaults, dict
            ), "Should return dictionary of defaults"
    ...
    def test_scope_consistency_across_modules(self):
        ...
        try:
            ...
            consistency_ratio = (
                len(common_scopes) / total_unique_scopes
                if total_unique_scopes > 0
                else 0
            )
            assert (
                consistency_ratio >= 0.7
            ), f"Scope consistency too low: {consistency_ratio:.2%}"
