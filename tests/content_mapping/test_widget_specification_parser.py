...
class TestWidgetSpecificationParser(unittest.TestCase):
    ...
    def test_extract_widget_parameters_button(self):
        ...
        description = "Add a button labeled 'View Details' that opens https://example.com"
    ...
    def test_extract_widget_parameters_image(self):
        ...
        description = "Add an image from https://example.com/image.jpg with alt text 'Product'"
    ...
    def test_extract_widget_parameters_decorated_text(self):
        ...
        description = "Add decorated text 'Status: Active' with top label 'Status' and icon STAR"
    ...
    def test_convert_to_widget_object_button(self):
        ...
        self.assertEqual(widget_object["buttonList"]["buttons"][0]["text"], "View Details")
        self.assertEqual(
    ...
    def test_convert_to_widget_object_image(self):
        ...
        self.assertEqual(widget_object["image"]["imageUrl"], "https://example.com/image.jpg")
    ...
    def test_convert_to_widget_object_text(self):
        ...
        self.assertEqual(widget_object["textParagraph"]["text"], "Welcome to our service")
    ...
    def test_convert_to_widget_object_decorated_text(self):
        ...
        widget_object = self.parser.convert_to_widget_object("decoratedText", parameters)
        ...
        self.assertEqual(widget_object["decoratedText"]["startIcon"]["knownIcon"], "STAR")
