...
This document provides a complete overview of all Qdrant-related resources, tools, middleware, and integrations in the Groupon Google MCP Server.
...
- **Features**:
  ...
  - Groupon Google MCP middleware integration for automatic tool response storage
...
### Groupon Google MCP Integration
