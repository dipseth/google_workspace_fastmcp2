...
This guide provides comprehensive documentation of all configuration options for the Groupon Google MCP Server. Configuration is primarily managed through environment variables, with sensible defaults for development and production environments.
...
# ============================================
SERVER_NAME=Groupon Google MCP Server
SERVER_HOST=0.0.0.0
SERVER_PORT=6339
BASE_URL=https://google-mcp.groupon.internal:6339
LOG_LEVEL=INFO
...
OAUTH_REDIRECT_URI=https://google-mcp.groupon.internal:6339/oauth/callback
...
|----------|------|---------|-------------|----------|
| `SERVER_NAME` | string | "Groupon Google MCP Server" | Server display name | No |
| `SERVER_HOST` | string | "localhost" | Server bind address | No |
| `SERVER_PORT` | integer | 6339 | Server port | No |
| `BASE_URL` | string | "https://google-mcp.groupon.internal:6339" | Base URL for callbacks | Yes |
...
curl https://google-mcp.groupon.internal:6339/health_check
...
```bash
# Print all Groupon Google MCP environment variables
