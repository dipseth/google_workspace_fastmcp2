...
Complete API documentation for all authentication tools in the Groupon Google MCP Server.
...
**Resource Templating:**
- Leverages Groupon Google MCP's resource templating system
...
Groupon Google MCP supports **four distinct authentication flows**:
